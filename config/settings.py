"""
Django settings for Minha Vitrine project.
"""
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '172.18.0.107','10.25.10.216','192.168.0.146']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.categorias_ativas',
            ],
        },
    },
]
